...
For my next project, I plan to implement a similar tracking process; however, when doing the estimates, I would like to spend more time in planning what needs to be done and looking back at prior data to try and improve my estimations. One of the major problems I encountered when doing the estimations for my final project was that while I was working on an issue, sometimes I would discover a new issue or something that needed to be fixed or reimplemented. Rather than creating a sub-issue, I would count this as a part of the original task, which ended up adding the actual time spent. Next time, I want to be more specific about issues so that I can avoid this problem. 
